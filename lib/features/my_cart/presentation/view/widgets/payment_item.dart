    ...
    return   AnimatedContainer(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: isActive ==false ? Colors.transparent : AppColor.greenColor,
                blurRadius: 4
            )
          ],
          border: Border.all(
            color: isActive==false?  const Color(0xff808080) : AppColor.greenColor,
          ),
      
        ),
        child: image.contains("svg",)? SvgPicture.asset(image,
